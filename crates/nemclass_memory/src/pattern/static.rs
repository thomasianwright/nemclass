...
/// ```
/// # use nemclass_memory::{ida_pat, peid_pat, code_pat};
...
impl<const N: usize> Pattern<N> {
    ...
    /// ```
    /// # use nemclass_memory::{ida_pat, peid_pat} ;
